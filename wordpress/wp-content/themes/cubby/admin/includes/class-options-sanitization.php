...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __( 'No Repeat', 'cubby' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'cubby' ),
		'repeat-y'  => __( 'Repeat Vertically', 'cubby' ),
		'repeat'    => __( 'Repeat All', 'cubby' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'cubby' ),
		'top center'    => __( 'Top Center', 'cubby' ),
		'top right'     => __( 'Top Right', 'cubby' ),
		'center left'   => __( 'Middle Left', 'cubby' ),
		'center center' => __( 'Middle Center', 'cubby' ),
		'center right'  => __( 'Middle Right', 'cubby' ),
		'bottom left'   => __( 'Bottom Left', 'cubby' ),
		'bottom center' => __( 'Bottom Center', 'cubby' ),
		'bottom right'  => __( 'Bottom Right', 'cubby')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'cubby' ),
		'fixed'  => __( 'Fixed in Place', 'cubby')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'cubby' ),
		'italic'      => __( 'Italic', 'cubby' ),
		'bold'        => __( 'Bold', 'cubby' ),
		'bold italic' => __( 'Bold Italic', 'cubby' )
		);
